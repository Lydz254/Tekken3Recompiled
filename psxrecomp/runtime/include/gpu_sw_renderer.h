...
/* Select whether the complete sidecar owns the canonical centre for the
 * current present.  Off (default) splices canonical VRAM for upload-heavy 2D;
 * on preserves full-mirror gameplay interpolation. */
