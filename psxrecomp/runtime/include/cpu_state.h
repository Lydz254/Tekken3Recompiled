...
#else
__attribute__((visibility("default"))) void overlay_flush_cycles(void);
#endif
...
/* Real output aspect used by exact native-wide stage projection sites. */
extern void     gte_ws_set_dome_aspect(int num, int den);
