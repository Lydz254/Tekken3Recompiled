...
int main(int argc, char** argv) {
    ...
    std::set<uint32_t>    ws_cull_bias, ws_cull_right_sub,
                          ws_cull_range, ws_cull_a1; // [widescreen.cull]
    ...
    std::set<uint32_t>    ws_backdrop_packet_tag; // exact background packet stores
    ...
    std::vector<PSXRecompV4::RecompilerPatch> ws_native_patches;
    uint32_t ws_shell_index_site = 0, ws_shell_index_expected = 0,
             ws_shell_base_cols = 0, ws_shell_wide_cols = 0;
    ...
    if (!config_path.empty()) {
        ...
        ws_native_patches    = cfg.ws_native_patches;
        ws_shell_index_site = cfg.ws_shell_index_site;
        ws_shell_index_expected = cfg.ws_shell_index_expected;
        ws_shell_base_cols = cfg.ws_shell_base_cols;
        ws_shell_wide_cols = cfg.ws_shell_wide_cols;
        ...
        ws_cull_right_sub.insert(cfg.ws_cull_right_sub_sites.begin(),
                                 cfg.ws_cull_right_sub_sites.end());
        ...
        ws_cull_screen_x_expected = cfg.ws_cull_screen_x_expected;
        ...
        ws_backdrop_packet_tag.insert(cfg.ws_backdrop_packet_tag_sites.begin(),
                                      cfg.ws_backdrop_packet_tag_sites.end());
    ...
    if (!ws_config_path.empty()) {
        ...
        ws_cull_right_sub.insert(wscfg.ws_cull_right_sub_sites.begin(),
                                 wscfg.ws_cull_right_sub_sites.end());
        ...
        if (wscfg.ws_cull_screen_x_expected != 0) {
            if (ws_cull_screen_x_expected != 0 &&
                ws_cull_screen_x_expected !=
                    wscfg.ws_cull_screen_x_expected) {
                fmt::print(stderr,
                           "psxrecomp-game: FATAL: conflicting "
                           "widescreen.cull.screen_x_expected values\n");
                return 1;
            }
            ws_cull_screen_x_expected =
                wscfg.ws_cull_screen_x_expected;
        ...
        ws_backdrop_packet_tag.insert(wscfg.ws_backdrop_packet_tag_sites.begin(),
                                      wscfg.ws_backdrop_packet_tag_sites.end());
        ...
        PSXRecompV4::merge_recompiler_patches(
            ws_native_patches, wscfg.ws_native_patches);
        if (wscfg.ws_shell_index_site) {
            ws_shell_index_site = wscfg.ws_shell_index_site;
            ws_shell_index_expected = wscfg.ws_shell_index_expected;
            ws_shell_base_cols = wscfg.ws_shell_base_cols;
            ws_shell_wide_cols = wscfg.ws_shell_wide_cols;
        }
    ...
    codegen_config.ws_native_patches = ws_native_patches;
    codegen_config.ws_shell_index_site = ws_shell_index_site;
    codegen_config.ws_shell_index_expected = ws_shell_index_expected;
    codegen_config.ws_shell_base_cols = ws_shell_base_cols;
    codegen_config.ws_shell_wide_cols = ws_shell_wide_cols;
    ...
    codegen_config.ws_cull_right_sub_sites = ws_cull_right_sub;
    ...
    codegen_config.ws_cull_screen_x_expected =
        ws_cull_screen_x_expected;
    ...
    codegen_config.ws_backdrop_packet_tag_sites = ws_backdrop_packet_tag;
